...
Enter the compartment name. If the compartment is under the root compartment, you don't need to specify a parent_compartment_ocid, but if you want to, enter the tenancy ocid (e.g ` 
